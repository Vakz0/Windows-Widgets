...
Brancher **Windows Widgets** à la base **My Task List** (page Tracker).

## 1. Prérequis

1. Créer une [intégration interne](https://www.notion.so/my-integrations) (ex. `Windows Widgets`)
...
Fichier actif possible aussi dans `%APPDATA%\windows-widgets\config.json`  
